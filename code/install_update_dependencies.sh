...
run_command "Installing development tools and applications" "apt install --fix-missing -y libxcb-xfixes0-dev meson ninja-build uthash-dev cmake polybar rofi zsh imagemagick feh zsh-autosuggestions"
